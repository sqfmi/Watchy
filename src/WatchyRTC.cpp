...
void WatchyRTC::_DSConfig(String datetime){ //String datetime is YYYY:MM:DD:HH:MM:SS
    ...
    rtc_ds.squareWave(rtc_ds.SQWAVE_NONE); //disable square wave output
    rtc_ds.setAlarm(rtc_ds.ALM2_EVERY_MINUTE, 0, 0, 0, 0); //alarm wakes up Watchy every minute
    rtc_ds.alarmInterrupt(rtc_ds.ALARM_2, true); //enable alarm interrupt
}
